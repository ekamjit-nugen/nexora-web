...
export class PWAService {
  constructor(
    @InjectModel('PWAConfig', 'nexora_projects') private pwaConfigModel: Model<IPWAConfig>,
    @InjectModel('OfflineStore', 'nexora_projects') private offlineStoreModel: Model<IOfflineStore>,
    @InjectModel('ServiceWorkerCache', 'nexora_projects') private cacheModel: Model<IServiceWorkerCache>,
  ) {}
