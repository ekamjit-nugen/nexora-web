...
export class KnowledgeService {
  ...
  constructor(
    @InjectModel('Space', 'nexora_knowledge') private spaceModel: Model<ISpace>,
    @InjectModel('Page', 'nexora_knowledge') private pageModel: Model<IPage>,
    @InjectModel('PageVersion', 'nexora_knowledge') private versionModel: Model<IPageVersion>,
    @InjectModel('PageTemplate', 'nexora_knowledge') private templateModel: Model<IPageTemplate>,
    @InjectModel('Bookmark', 'nexora_knowledge') private bookmarkModel: Model<IBookmark>,
