...
export class AssetService {
  ...
  constructor(
    @InjectModel('Asset', 'nexora_asset') private assetModel: Model<IAsset>,
    @InjectModel('AssetCategory', 'nexora_asset') private categoryModel: Model<IAssetCategory>,
    @InjectModel('AssetAssignment', 'nexora_asset') private assignmentModel: Model<IAssetAssignment>,
    @InjectModel('AssetMaintenance', 'nexora_asset') private maintenanceModel: Model<IAssetMaintenance>,
    @InjectModel('AssetCounter', 'nexora_asset') private counterModel: Model<IAssetCounter>,
  ) {}
