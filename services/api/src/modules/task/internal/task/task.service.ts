...
export class TaskService {
  ...
  constructor(
    ...
    @InjectModel('Board', 'nexora_tasks') private boardModel: Model<IBoard>,
    @InjectModel('Counter', 'nexora_tasks') private counterModel: Model<ICounter>,
    @InjectModel('Timesheet', 'nexora_tasks') private timesheetModel: Model<ITimesheet>,
    @InjectModel('Activity', 'nexora_tasks') private activityModel: Model<IActivity>,
    @InjectModel('Sprint', 'nexora_tasks') private sprintModel: Model<ISprint>,
    @InjectModel('CustomField', 'nexora_tasks') private customFieldModel: Model<ICustomField>,
    @InjectModel('AutomationRule', 'nexora_tasks') private automationRuleModel: Model<IAutomationRule>,
