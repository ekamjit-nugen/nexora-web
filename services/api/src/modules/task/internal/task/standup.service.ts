...
export class StandupService {
  ...
  constructor(
    @InjectModel('Standup', 'nexora_tasks') private standupModel: Model<IStandup>,
    @InjectModel('StandupResponse', 'nexora_tasks') private responseModel: Model<IStandupResponse>,
