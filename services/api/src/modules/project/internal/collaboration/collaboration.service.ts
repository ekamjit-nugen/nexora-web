...
export class CollaborationService {
  ...
  constructor(
    @InjectModel('CollaborationSession', 'nexora_projects') private sessionModel: Model<ICollaborationSession>,
    @InjectModel('CollaborativeEdit', 'nexora_projects') private editModel: Model<ICollaborativeEdit>,
    @InjectModel('ConflictResolution', 'nexora_projects') private conflictModel: Model<IConflictResolution>,
  ) {}
