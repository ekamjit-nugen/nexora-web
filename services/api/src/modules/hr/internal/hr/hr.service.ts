...
export class HrService {
  ...
  constructor(
    @InjectModel('Employee', 'nexora_hr') private employeeModel: Model<IEmployee>,
    @InjectModel('EmployeeProfileAudit', 'nexora_hr') private auditModel: Model<IEmployeeProfileAudit>,
    @InjectModel('Department', 'nexora_hr') private departmentModel: Model<IDepartment>,
    @InjectModel('Designation', 'nexora_hr') private designationModel: Model<IDesignation>,
    @InjectModel('Team', 'nexora_hr') private teamModel: Model<ITeam>,
    @InjectModel('Client', 'nexora_hr') private clientModel: Model<IClient>,
    @InjectModel('Invoice', 'nexora_hr') private invoiceModel: Model<IInvoice>,
    @InjectModel('InvoiceTemplate', 'nexora_hr') private invoiceTemplateModel: Model<IInvoiceTemplate>,
    @InjectModel('CallLog', 'nexora_hr') private callLogModel: Model<ICallLog>,
    @InjectModel('BillingRate', 'nexora_hr') private billingRateModel: Model<IBillingRate>,
    @InjectModel('EmployeeStatus', 'nexora_hr') private employeeStatusModel: Model<IEmployeeStatus>,
  ) {}
