...
export class RoleService {
  constructor(
    @InjectModel('Role', 'nexora_projects') private roleModel: Model<IRole>,
    @InjectModel('RoleAssignment', 'nexora_projects') private assignmentModel: Model<IRoleAssignment>,
  ) {
