...
export class HelpdeskService {
  ...
  constructor(
    @InjectModel('Ticket', 'nexora_helpdesk') private ticketModel: Model<ITicket>,
    @InjectModel('TicketComment', 'nexora_helpdesk') private commentModel: Model<ITicketComment>,
    @InjectModel('HelpdeskTeam', 'nexora_helpdesk') private teamModel: Model<IHelpdeskTeam>,
    @InjectModel('TicketCounter', 'nexora_helpdesk') private counterModel: Model<ITicketCounter>,
  ) {}
