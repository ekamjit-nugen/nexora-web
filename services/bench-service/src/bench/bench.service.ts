...
export class BenchService {
  ...
  constructor(
    @InjectModel('BenchSnapshot') private snapshotModel: Model<IBenchSnapshot>,
    @InjectModel('ResourceRequest') private requestModel: Model<IResourceRequest>,
    @InjectModel('BenchConfig') private configModel: Model<IBenchConfig>,
