          ...
          <div className="px-4 py-3.5 border-b border-[#E2E8F0] bg-gradient-to-b from-white to-[#FAFBFC] shrink-0">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                {user && (user.role === "manager" || user.role === "admin" || user.role === "owner" || user.role === "super_admin" || (user.roles && (user.roles.includes("manager") || user.roles.includes("admin") || user.roles.includes("owner") || user.roles.includes("super_admin")))) && (
                  <button
                    onClick={() => { window.location.href = "/messages/analytics"; }}
                    className="p-1 rounded-lg transition-colors text-[#94A3B8] hover:text-[#64748B] hover:bg-[#F1F5F9]"
