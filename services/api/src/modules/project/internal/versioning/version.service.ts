...
export class VersionService {
  constructor(
    @InjectModel('ProductVersion', 'nexora_projects') private versionModel: Model<IProductVersion>,
    @InjectModel('VersionHistory', 'nexora_projects') private historyModel: Model<IVersionHistory>,
  ) {}
  ...
  private async updateHistory(
    ...
    history.totalVersions = (history.totalVersions || 0) + 1;
