...
export class PayrollService {
  ...
  constructor(
    @InjectModel('SalaryStructure', 'nexora_payroll') private salaryStructureModel: Model<ISalaryStructure>,
    @InjectModel('PayrollRun', 'nexora_payroll') private payrollRunModel: Model<IPayrollRun>,
    @InjectModel('PayrollEntry', 'nexora_payroll') private payrollEntryModel: Model<IPayrollEntry>,
    @InjectModel('Payslip', 'nexora_payroll') private payslipModel: Model<IPayslip>,
    @InjectModel('InvestmentDeclaration', 'nexora_payroll') private investmentDeclarationModel: Model<IInvestmentDeclaration>,
    @InjectModel('ExpenseClaim', 'nexora_payroll') private expenseClaimModel: Model<IExpenseClaim>,
    @InjectModel('EmployeeLoan', 'nexora_payroll') private employeeLoanModel: Model<IEmployeeLoan>,
    @InjectModel('Onboarding', 'nexora_payroll') private onboardingModel: Model<IOnboarding>,
    @InjectModel('Offboarding', 'nexora_payroll') private offboardingModel: Model<IOffboarding>,
    @InjectModel('AnalyticsSnapshot', 'nexora_payroll') private analyticsSnapshotModel: Model<IAnalyticsSnapshot>,
    @InjectModel('JobPosting', 'nexora_payroll') private jobPostingModel: Model<IJobPosting>,
    @InjectModel('Candidate', 'nexora_payroll') private candidateModel: Model<ICandidate>,
    @InjectModel('StatutoryReport', 'nexora_payroll') private statutoryReportModel: Model<IStatutoryReport>,
    @InjectModel('Goal', 'nexora_payroll') private goalModel: Model<IGoal>,
    @InjectModel('ReviewCycle', 'nexora_payroll') private reviewCycleModel: Model<IReviewCycle>,
    @InjectModel('PerformanceReview', 'nexora_payroll') private performanceReviewModel: Model<IPerformanceReview>,
    @InjectModel('Announcement', 'nexora_payroll') private announcementModel: Model<IAnnouncement>,
    @InjectModel('Kudos', 'nexora_payroll') private kudosModel: Model<IKudos>,
    @InjectModel('Survey', 'nexora_payroll') private surveyModel: Model<ISurvey>,
    @InjectModel('SurveyResponse', 'nexora_payroll') private surveyResponseModel: Model<ISurveyResponse>,
    @InjectModel('Course', 'nexora_payroll') private courseModel: Model<ICourse>,
    @InjectModel('Enrollment', 'nexora_payroll') private enrollmentModel: Model<IEnrollment>,
    @InjectModel('Certificate', 'nexora_payroll') private certificateModel: Model<ICertificate>,
    @InjectModel('LearningPath', 'nexora_payroll') private learningPathModel: Model<ILearningPath>,
    @InjectModel('Counter', 'nexora_payroll') private counterModel: Model<ICounter>,
