...
export class PolicyService {
  ...
  constructor(
    @InjectModel('Policy', 'nexora_policies') private policyModel: Model<IPolicy>,
    @InjectModel('PolicyAcknowledgement', 'nexora_policies') private acknowledgementModel: Model<IPolicyAcknowledgement>,
  ) {}
