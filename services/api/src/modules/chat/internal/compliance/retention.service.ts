...
export class RetentionService {
  ...
  constructor(
    @InjectModel('RetentionPolicy', 'nexora_chat') private policyModel: Model<IRetentionPolicy>,
    @InjectModel('LegalHold', 'nexora_chat') private legalHoldModel: Model<ILegalHold>,
